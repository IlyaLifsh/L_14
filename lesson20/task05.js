const cats = [
  ...
  { name: 'Shadow', age: 2, color: 'gray' , weight: 5.8},
  { name: 'Simba', age: 1, color: 'orange' , weight: 3.9}
];

const totalWeight = cats.reduce((accumulator, cat) => 
    accumulator + cat.weight, 0);
console.log("Общий вес всех котов:", totalWeight);
